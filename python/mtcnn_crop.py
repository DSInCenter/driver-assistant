...
detector = MTCNN()
gen = os.walk('/home/nimahsn/Downloads/Compressed/CASIA-WebFace')
next(gen)
    
for a in gen:
    src = a[0]
    tar = '/home/nimahsn/Downloads/Compressed/CASIA-cropped/' + os.path.basename(os.path.normpath(a[0]))
    crop_image(src, tar, 1)
# if (i==2):
        #     break
